...
>>>>>>> 5b5a50ae0f1c09d132b0000926369db45a335edb
...
>>>>>>> 5b5a50ae0f1c09d132b0000926369db45a335edb
  ...
  PRIMARY KEY (`id`),
<<<<<<< HEAD
  KEY `FK_badd7c11-0e39-4679-97fc-7722f26d7f08` (`recommended_age_id`),
=======
...
<<<<<<< HEAD
  CONSTRAINT `FK_badd7c11-0e39-4679-97fc-7722f26d7f08` FOREIGN KEY (`recommended_age_id`) REFERENCES `recommended_ages` (`id`)
=======
<<<<<<< HEAD
<<<<<<< HEAD
...
CREATE TABLE `carts` (
  ...
  KEY `FK_0762ef1c-dde7-479f-8ec7-06a274d748a8` (` purchase_detail_id`),
  KEY `FK_af7ed11e-1b81-4001-b522-9c7f1802467c` (` payment_id`),
<<<<<<< HEAD
  CONSTRAINT `FK_0762ef1c-dde7-479f-8ec7-06a274d748a8` FOREIGN KEY (` purchase_detail_id`) REFERENCES ` purchase_details` (`id`),
=======
<<<<<<< HEAD
<<<<<<< HEAD
...
<<<<<<< HEAD
-- Dump completed on 2021-09-30 14:32:32
=======
<<<<<<< HEAD
<<<<<<< HEAD
