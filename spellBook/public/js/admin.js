    ...
    $titulo.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$titulo.value.trim():
                $tituloError.innerHTML = 'El campo nombre es obligatorio'
               $titulo.classList.add('invalid')
                break;
            case !regExAlpha.test($titulo.value):
                $tituloError.innerHTML = 'Ingresa un nombre válido'
               $titulo.classList.add('invalid')
                break;    
            default:
    ...
    $cantidad.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$cantidad.value.trim():
                $cantidadError.innerHTML = 'El Stock es obligatorio'
    ...
    $precio.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$precio.value.trim():
                $precioError.innerHTML = 'El precio es obligatorio'
    ...
    $publisher.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$publisher.value.trim():
                $publisherError.innerHTML = 'La editorial es obligatorio'
    ...
    $language.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$language.value.trim():
                $languageError.innerHTML = 'El idioma es obligatorio'
    ...
    $publicationYear.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$publicationYear.value.trim():
                $publicationYearError.innerHTML = 'El año de publicación es obligatorio'
    ...
    $pages.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$pages.value.trim():
                $pagesError.innerHTML = 'La cantidad de páginas es obligatorio'
    ...
    $descripcion.addEventListener('blur', function(){
        ...
        switch (true) {
            case !$descripcion.value.trim():
                $descripcionError.innerHTML = 'La descripción es obligatorio'
